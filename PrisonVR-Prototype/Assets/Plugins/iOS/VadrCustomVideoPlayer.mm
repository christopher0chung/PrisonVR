...
@implementation VadrCustomVideoPlayerView
+ (Class)layerClass
{
...
@implementation VadrCustomVideoPlayer
{
...
- (BOOL)_play:(VadrCustomVideoPlayerView*)view
{
    if(!_playerReady)
        return NO;
...
- (BOOL)playToView:(VadrCustomVideoPlayerView*)view   { return [self _play:view]; }
